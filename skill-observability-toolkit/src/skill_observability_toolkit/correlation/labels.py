...
class LabelManager:
    ...
    def get_label(self, key: str) -> Optional[UnifiedLabel]:
        """
        Get a label by key.
    ...
    def apply_to_trace(self, trace_id: str, labels: Optional[Dict[str, str]] = None) -> bool:
        """
    ...
    def apply_to_span(self, trace_id: str, span_id: str, labels: Optional[Dict[str, str]] = None) -> bool:
        """
