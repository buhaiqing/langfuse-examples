...
class GitHubActionsAdapter:
    ...
    @property
    def run_number(self) -> Optional[str]:
        """Get run number."""
        return self._env.get("GITHUB_RUN_NUMBER")
    
    @property
    def run_attempt(self) -> Optional[str]:
...
def get_github_workflow_info() -> Optional[Dict[str, Any]]:
    """
...
def generate_github_summary() -> Optional[str]:
    """
