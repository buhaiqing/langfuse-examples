...
# CI trace context
_ci_trace_id_context: ContextVar[str | None] = ContextVar(
    "ci_trace_id", default=None
)

# CI stage context
_ci_stage_context: ContextVar[str | None] = ContextVar(
    "ci_stage", default=None
)

# Current step context
_current_step_context: ContextVar[str | None] = ContextVar(
