...
class AssertionEngine:
    ...
    def _check_value_greater_than(self, value: Union[int, float], threshold: Union[int, float], **kwargs) -> AssertionResult:
    ...
    def _check_value_less_than(self, value: Union[int, float], threshold: Union[int, float], **kwargs) -> AssertionResult:
    ...
    def _check_value_in_range(self, value: Union[int, float], min_val: Union[int, float], max_val: Union[int, float], **kwargs) -> AssertionResult:
    ...
    def _check_performance(self, duration_ms: Union[int, float], threshold_ms: Union[int, float] = 5000, **kwargs) -> AssertionResult:
    ...
    def _check_cost_within_budget(self, cost: Union[int, float], budget: Union[int, float], **kwargs) -> AssertionResult:
    ...
    def execute_assertion(
        ...
        try:
            ...
            raise AssertionExecutionError(f"Error executing check '{check_name}': {e}")
