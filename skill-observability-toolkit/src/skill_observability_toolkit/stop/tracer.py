...
class TracerContext:
    ...
    def pop_span(self) -> dict[str, Any] | None:
        """
...
class Span:
    ...
    def end(self, output: dict[str, Any] | None = None, status: str = "success") -> "Span":
        """
...
class STOPTracer:
    ...
    def start_trace(self, trace_id: str | None = None, name: str = "skill_execution") -> "STOPTracer":
        """
        Start a new trace.
    ...
    def start_span(self, name: str, input_data: dict[str, Any] | None = None) -> "SpanContextManager":
        """
...
class SpanContextManager:
    ...
    def __init__(self, tracer: STOPTracer, name: str, input_data: dict[str, Any] | None = None):
        """
